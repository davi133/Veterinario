...
public class AnimalController implements Initializable{
    ...
    @FXML private TableColumn<Animal, Integer> table_id;
    @FXML private TableColumn<Animal, String> table_nome;
    @FXML private TableColumn<Animal, Integer> table_nasc;
    @FXML private TableColumn<Animal, String> table_sexo;
    @FXML private TableColumn<Animal, Integer> table_dono;
    @FXML private TableColumn<Animal, Integer> table_especie;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		ObservableList<Animal> lista = FXCollections.observableArrayList(AnimalDAO.getInstance().retrieveAll(limitePadrao));
